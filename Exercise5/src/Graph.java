...
public class Graph {
	...
	void kruskal() throws IOException {
		...
		for (i = 0; i < j; i++) {
			...
			Exercise5.writer.write("edge: " + result[i].start + ", " + result[i].end + ", " + result[i].weight + "\n");
		}
		Exercise5.writer.write("\n");
		Exercise5.writer.write("Kruskal spanning tree weight is " + totalWeight);
	}
